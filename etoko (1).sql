...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2019 at 01:42 PM
...
CREATE TABLE `keranjang_detail` (
  `id_keranjangDetail` int(10) UNSIGNED NOT NULL,
  `id_keranjang` int(10) UNSIGNED NOT NULL,
  `id_satuan` int(10) UNSIGNED NOT NULL,
  `qty` double(8,2) NOT NULL,
  `jumlah_harga` double(8,2) NOT NULL,
...
(23, '2019_12_15_071458_create_toko_table', 1),
(24, '2019_12_15_071502_create_laba_table', 1),
(25, '2019_12_15_071905_create_jenis_table', 1),
(26, '2019_12_15_072018_create_barang_table', 1),
(27, '2019_12_15_081128_create_satuan_table', 1),
(28, '2019_12_15_082016_create_user_table', 1),
(29, '2019_12_15_082017_create_pemesanan_table', 1),
(30, '2019_12_15_082019_create_detail_pemesanan_table', 1),
(31, '2019_12_15_110125_create_transaksi_table', 1),
(32, '2019_12_15_110846_create_pengeluaran_table', 1),
(33, '2019_12_15_111354_create_suplaier_table', 1),
(34, '2019_12_15_111518_create_detail_pengeluaran_table', 1),
(35, '2019_12_15_112358_create_member_table', 1),
(36, '2019_12_15_113058_create_keranjang_table', 1),
(37, '2019_12_15_113403_create_keranjang_detail_table', 1);
...
ALTER TABLE `detail_pemesanan`
  ...
  ADD KEY `detail_pemesanan_id_satuan_foreign` (`id_satuan`),
...
ALTER TABLE `keranjang_detail`
  ADD PRIMARY KEY (`id_keranjangDetail`),
  ADD KEY `keranjang_detail_id_keranjang_foreign` (`id_keranjang`),
  ADD KEY `keranjang_detail_id_satuan_foreign` (`id_satuan`);
...
ALTER TABLE `satuan`
  ...
  ADD KEY `satuan_id_barang_foreign` (`id_barang`);
...
--
ALTER TABLE `keranjang_detail`
  MODIFY `id_keranjangDetail` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `barang`
  ADD CONSTRAINT `barang_id_jenis_foreign` FOREIGN KEY (`id_jenis`) REFERENCES `jenis` (`id_jenis`);
...
ALTER TABLE `detail_pemesanan`
  ...
  ADD CONSTRAINT `detail_pemesanan_id_satuan_foreign` FOREIGN KEY (`id_satuan`) REFERENCES `satuan` (`id_satuan`);
...
--
ALTER TABLE `keranjang`
  ADD CONSTRAINT `keranjang_id_member_foreign` FOREIGN KEY (`id_member`) REFERENCES `member` (`id_member`);

--
-- Constraints for table `keranjang_detail`
--
ALTER TABLE `keranjang_detail`
  ADD CONSTRAINT `keranjang_detail_id_keranjang_foreign` FOREIGN KEY (`id_keranjang`) REFERENCES `keranjang` (`id_keranjang`),
  ADD CONSTRAINT `keranjang_detail_id_satuan_foreign` FOREIGN KEY (`id_satuan`) REFERENCES `satuan` (`id_satuan`);
...
--
ALTER TABLE `satuan`
  ADD CONSTRAINT `satuan_id_barang_foreign` FOREIGN KEY (`id_barang`) REFERENCES `barang` (`id_barang`);
